...
function ProjectCards({ title , desc , techs = [] }) {
  return (
    <div className="p-4 flex flex-col justify-around h-[36vh] bg-[#102240] text-[#C1D3F1] transition transform hover:-translate-y-2 motion-reduce:transition-none motion-reduce:hover:transform-none ">
        <div className="flex justify-between">
        <span className='text-6xl'><i class="fa-regular fa-folder"></i></span>
        <a href="" className='text-2xl'><i class="fa-solid fa-up-right-from-square"></i></a>
        </div>
